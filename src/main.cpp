...
#include <terrainEngine/Window.h>
#include <shader.h>
#include <terrainEngine/ScreenSpaceShader.h>
#include <terrainEngine/texture.h>

#include <terrainEngine/VolumetricClouds.h>
#include <terrainEngine/Terrain.h>
#include <terrainEngine/Skybox.h>
#include <terrainEngine/Water.h>
#include <terrainEngine/CloudsModel.h>
...
#include <terrainEngine/glError.h>

#include <terrainEngine/sceneElements.h>
#include <terrainEngine/drawableObject.h>
#include <terrainEngine/GUI.h>
...
int main()
{
	...
	glm::vec3 lightPosition(0.0f), seed(0.0f);
	...
	ScreenSpaceShader PostProcessing("../src/shaders/terrainEngine/post_processing.frag");
	ScreenSpaceShader fboVisualizer("../src/shaders/terrainEngine/visualizeFbo.frag");

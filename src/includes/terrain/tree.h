...
class Tree {
  ...
  public:
    void Init() {
        // compile the shaders.
		Shader shader("../src/shaders/terrain/tree_vshader.glsl", "../src/shaders/terrain/tree_fshader.glsl");
        ...
        {
            initTexture("../resources/terrain/tree/tree_texture.tga", &tree_texture_id_, "tree_tex", GL_TEXTURE0);
            initTexture("../resources/terrain/tree/desert_tree_texture.tga", &desert_tree_texture_id_, "desert_tree_tex", GL_TEXTURE0 + 1);
            initTexture("../resources/terrain/tree/cactus_texture.tga", &cactus_texture_id_, "cactus_tex", GL_TEXTURE0 + 2);
            initTexture("../resources/terrain/tree/algae_texture.tga", &algae_texture_id_, "algae_tex", GL_TEXTURE0 + 3);
            initTexture("../resources/terrain/tree/snowy_tree_texture.tga", &snowy_texture_id_, "snowy_tex", GL_TEXTURE0 + 4);
            initTexture("../resources/terrain/tree/reed_texture.tga", &reed_texture_id_, "reed_tex", GL_TEXTURE0 + 5);
        }

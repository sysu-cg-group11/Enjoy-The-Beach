...
class Water {
  ...
  public:
    void Init(GLuint tex_reflection_id) {
        // compile the shaders.
		Shader shader("../src/shaders/terrain/water_vshader.glsl", "../src/shaders/terrain/water_fshader.glsl");
        ...
        {
            initTexture("../resources/terrain/water/normal_texture_water.tga", &normal_texture_id_, "normal_tex", GL_TEXTURE0);
            initTexture("../resources/terrain/water/normal_texture_water2.tga", &normal_texture2_id_, "normal_tex2", GL_TEXTURE0 + 1);
        }

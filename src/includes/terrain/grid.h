...
struct Light {
    ...
    void Setup(GLuint program_id) {
        ...
        glUniform3fv(glGetUniformLocation(program_id, "La"), 1, glm::value_ptr(La));
        glUniform3fv(glGetUniformLocation(program_id, "Ld"), 1, glm::value_ptr(Ld));
        glUniform3fv(glGetUniformLocation(program_id, "Ls"), 1, glm::value_ptr(Ls));
    }
};
...
struct Material {
    ...
    void Setup(GLuint program_id) {
        ...
        glUniform3fv(glGetUniformLocation(program_id, "ka"), 1, glm::value_ptr(ka));
        glUniform3fv(glGetUniformLocation(program_id, "kd"), 1, glm::value_ptr(kd));
        glUniform3fv(glGetUniformLocation(program_id, "ks"), 1, glm::value_ptr(ks));
...
class Grid : public Material, public Light {
  ...
  public:
    void Init() {
        // compile the shaders.
		Shader shader("../src/shaders/terrain/grid_vshader.glsl", "../src/shaders/terrain/grid_fshader.glsl");
        ...
        {
            initTexture("../resources/terrain/grid/sand_texture.tga", &sand_texture_id_, "sand_tex", GL_TEXTURE0 + 1);
            initTexture("../resources/terrain/grid/grass_texture.tga", &grass_texture_id_, "grass_tex", GL_TEXTURE0 + 2);
            initTexture("../resources/terrain/grid/rock_texture.tga", &rock_texture_id_, "rock_tex", GL_TEXTURE0 + 3);
            initTexture("../resources/terrain/grid/snow_texture.tga", &snow_texture_id_, "snow_tex", GL_TEXTURE0 + 4);
        }

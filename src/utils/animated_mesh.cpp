...
AnimationTexture::AnimationTexture(GLenum TextureTarget, const std::string& FileName)
{
...
void AnimationTexture::Bind(GLenum TextureUnit)
{
...
void AnimationMesh::InitMesh(uint MeshIndex,
...
bool AnimationMesh::InitMaterials(const aiScene* pScene, const string& Filename)
{
    ...
    for (uint i = 0 ; i < pScene->mNumMaterials ; i++) {
        ...
        if (pMaterial->GetTextureCount(aiTextureType_DIFFUSE) > 0) {
            ...
            if (pMaterial->GetTexture(aiTextureType_DIFFUSE, 0, &Path, NULL, NULL, NULL, NULL, NULL) == AI_SUCCESS) {
                ...
                m_Textures[i] = new AnimationTexture(GL_TEXTURE_2D, FullPath.c_str());
...
uint AnimationMesh::FindPosition(float AnimationTime, const aiNodeAnim* pNodeAnim)
{    
...
uint AnimationMesh::FindScaling(float AnimationTime, const aiNodeAnim* pNodeAnim)
{
...
void AnimationMesh::BoneTransform(float TimeInSeconds, vector<Matrix4f>& Transforms)
{
    Matrix4f Identity;
...
const aiNodeAnim* AnimationMesh::FindNodeAnim(const aiAnimation* pAnimation, const string NodeName)
{

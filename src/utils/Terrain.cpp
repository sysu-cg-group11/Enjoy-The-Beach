#include <terrainEngine/Terrain.h>
#include <GLFW/glfw3.h>

#include "terrainEngine/sceneElements.h"
...
Terrain::Terrain(int gl)
{
	...
	shad->attachShader("../src/shaders/terrainEngine/terrain.vert")
		->attachShader("../src/shaders/terrainEngine/terrain.tcs")
		->attachShader("../src/shaders/terrainEngine/terrain.tes")
		->attachShader("../src/shaders/terrainEngine/terrain.frag")
		->linkPrograms();
	...
	textures[0] = TextureFromFile("sand.jpg", "../resources/terrainEngine");
	textures[1] = TextureFromFile("grass.jpg", "../resources/terrainEngine");
	textures[2] = TextureFromFile("rdiffuse.jpg", "../resources/terrainEngine");
	textures[3] = TextureFromFile("snow2.jpg", "../resources/terrainEngine");
	textures[4] = TextureFromFile("rnormal.jpg", "../resources/terrainEngine");
	textures[5] = TextureFromFile("terrainTexture.jpg", "../resources/terrainEngine");

...
{
	volumetricCloudsShader = new Shader("volumetricCloudsShader", "../src/shaders/terrainEngine/volumetric_clouds.comp");
	postProcessingShader = new ScreenSpaceShader("../src/shaders/terrainEngine/clouds_post.frag");
	//compute shaders
	weatherShader = new Shader("weatherMap");
	weatherShader->attachShader("../src/shaders/terrainEngine/weather.comp");
...
void CloudsModel::generateModelTextures()
{
	...
	if (!perlinTex) {
		...
		comp.attachShader("../src/shaders/terrainEngine/perlinworley.comp");
		comp.linkPrograms();
	...
	if (!worley32) {
		...
		worley_git.attachShader("../src/shaders/terrainEngine/worley.comp");
